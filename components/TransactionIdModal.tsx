    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-sm m-4">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
          Please enter the transaction ID you received after manually sending the payment.
        </p>
        <input
          type="text"
          value={transactionId}
        ...
        <div className="flex justify-end space-x-4 mt-6">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg text-white bg-green-600 hover:bg-green-700 font-semibold transition-colors inline-flex items-center disabled:bg-green-400"
            disabled={isLoading}
          >
            {isLoading && <Spinner />}
            Confirm Approval
